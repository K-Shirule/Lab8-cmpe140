module hazard_control (
    ...
    input [4:0] decode_stage_register_read_a, decode_stage_register_read_b, decode_stage_register_write;
    input [4:0] execute_stage_register_read_a, execute_stage_register_read_b, execute_stage_register_write;
    input [4:0] memory_stage_register_read_a, memory_stage_register_read_b, memory_stage_register_write;
    input [4:0] register_writeback_stage_register_read_a, register_writeback_stage_register_read_b, register_writeback_stage_register_write;
