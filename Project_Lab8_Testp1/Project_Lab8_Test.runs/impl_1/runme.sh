...
HD_PWD='C:/Users/lehat/OneDrive/Desktop/CMPE140Lab7/Project_Lab8_Test/Project_Lab8_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cyc_SoC_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Single_Cyc_SoC_fpga.tcl -notrace
