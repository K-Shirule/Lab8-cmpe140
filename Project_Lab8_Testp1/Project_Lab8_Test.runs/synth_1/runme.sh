...
HD_PWD='C:/Users/lehat/OneDrive/Desktop/CMPE140Lab7/Project_Lab8_Test/Project_Lab8_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cyc_SoC_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Single_Cyc_SoC_fpga.tcl
